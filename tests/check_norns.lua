...
if not source:find("Endless DJ v1.139", 1, true) then
  fail("Script version must match PR #139")
end
pass("Script version matches PR #139")
...
do
  ...
  for _, token in ipairs({
    ...
    'version="v1.139"', 'sample_library=sample_library',
  }) do
    if not source:find(token, 1, true) then
