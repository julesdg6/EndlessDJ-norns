...
nmono_model_palettes = {
  ...
  TECHNO={0,1,4}, GARAGE4={1,2,3,4}, TWO_STEP={1,2,3,4},
  BREAKS={0,1,2,4}, DUBSTEP={1,2,4,5}, DEEP={0,1,3},
  ACID={0,1}, TRANCE={0,1,4}, PROG={0,1,2},
  JUNGLE={1,2,4}, DNB={1,2,4,5}, LIQUID={1,2,3},
  HARDTECHNO={1,2,4,5}, ELECTRO={0,2,4,5}, JUKE={1,3,4},
  AFRO={0,1,3}, MINIMAL={0,1}, MELODIC={0,1,2},
...
nmono_apply_deck = function(deck, sync_params)
  ...
  params:set("nmono_model", (deck.nmono.model or 0) + 1, true)
...
function init()
  ...
  params:set_action("nmono_preset", function(v)
    ...
    settings.model = (deck.nmono and deck.nmono.model) or 0
    deck.nmono = settings
  ...
  params:add_option("nmono_model", "n-mono model", nmono_model_names, 1)
  params:set_action("nmono_model", function(v)
    local deck = current_deck()
    deck.nmono.model = v - 1
    internal_engine.set_nmono(internal_engine.deck_id(deck, deck_a), deck.nmono)
  end)
